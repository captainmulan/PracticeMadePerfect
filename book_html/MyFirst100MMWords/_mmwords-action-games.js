...
(function (w) {
  ...
  /** Side-scrolling runner — Family / Home / School */
  function bootRunner(opts) {
    ...
    var themes = {
      family: {
        skyTop: "#1e1035", skyBot: "#4c1d95", ground: "#3d2b1f", groundAccent: "#5c4033",
        obs: "puddle", label: "🪔 Thadingyut lane", village: true
      },
      home: {
