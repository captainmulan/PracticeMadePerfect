  ...
  var CHAPTERS = [
    {
      ...
      quizQuestions: [
            ...
            {
                  "q": "What did Grandfather show Su in the family photo album?",
                  "options": [
    ...
    },
    {
      ...
      badge: "Food Master",
      gameType: "tea-dash",
      gameTitle: "Tea Shop Dash",
      gameHint: "Slide the tray — catch tea cups and bowls!",
      gameTarget: 8,
      ...
      segmentExplanations: [
        "At sunrise, families share rice, water, and fruit with monks walking for alms.",
        "Tea shops gather neighbors over sweet tea, eggs, bread, and lahpet thoke.",
        "Sharing food builds a generous heart, not a selfish one."
      ],
      story: "At sunrise, Kyaw waited by the lane with a bowl of rice and fresh bananas. Monks walked barefoot with empty bowls, and Kyaw carefully spooned rice into each one. He poured water from a clay pot and bowed with both hands. Mother watched from the doorway and smiled. \"In Myanmar, we share food with monks before we eat our fill,\" she said.\n\nKyaw followed Grandfather to the neighborhood tea shop. Old friends sat around low tables, laughing over sweet milk tea and warm bread. One man passed around lahpet thoke while another cracked a soft-boiled egg into his soup. The shop smelled of tea and kindness. \"Food brings neighbors together,\" Grandfather said, pouring Kyaw a tiny cup.\n\nA thin dog waited outside the gate. Kyaw saved bread and fish from his plate and filled a bowl with water. The dog wagged its tail and ate slowly. That night Kyaw fell asleep happy, still tasting mango and milk, knowing full bellies can choose to be kind.",
    ...
    },
    {
      ...
      badge: "Animal Friend",
      gameType: "jungle-hop",
      gameTitle: "Jungle Hop",
      gameHint: "Jump platforms — collect animals in the forest!",
      gameTarget: 8,
    ...
    },
    {
      ...
      title: "Colors",
      badge: "Color Artist",
      gameType: "rainbow-climb",
      gameTitle: "Rainbow Bridge Climb",
      gameHint: "Climb colored steps across the river — reach the top!",
      gameTarget: 8,
    ...
    },
    {
      ...
      title: "Numbers",
      badge: "Number Ninja",
      gameType: "market-sprint",
      gameTitle: "Market Sprint",
      gameHint: "Hit the stall with the right number of mangoes!",
      gameTarget: 8,
    ...
    },
    {
      ...
      title: "Body Parts",
      badge: "Body Explorer",
      gameType: "obstacle-course",
      gameTitle: "Obstacle Course",
      gameHint: "Jump low bars, duck high ones — keep running!",
      gameTarget: 8,
    ...
    },
    {
      ...
      title: "Home",
      badge: "Home Helper",
      gameType: "room-runner",
      gameTitle: "Room Runner",
      gameHint: "Run through the house — dodge furniture, collect items!",
      gameTarget: 8,
    ...
    },
    {
      ...
      gameType: "bell-rush",
      gameTitle: "Bell Rush",
      gameHint: "Race to school — jump desks before the bell!",
      gameTarget: 8,
    ...
    },
    {
      ...
      gameType: "mood-hop",
      gameTitle: "Mood Hop",
      gameHint: "Land on happy faces 😊 — avoid sad and angry!",
      gameTarget: 8,
    ...
    },
    {
      ...
      badge: "Festival Fan",
      gameType: "fireworks-dodge",
      gameTitle: "Fireworks Dodge",
      gameHint: "Collect lanterns — dodge festival sparks!",
      gameTarget: 8,
