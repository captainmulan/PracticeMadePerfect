...
export type CourseStepType = "html" | "code-exam" | "quiz" | "pdf" | "epub";
...
export function courseStepLabel(step: CourseStep): string {
  ...
  if (step.stepType === "epub") return "EPUB";
  return "Quiz";
}
...
export const DEFAULT_COURSES: Course[] = [
    ...
    chapters: [
      {
        ...
        chapterIndex: 0,
        title: "Introduction",
        description: "Welcome to React CRUD Premium!",
        steps: [
          {
  ...
  <p>These apps need reliable create, read, update, and delete behavior to keep data consistent and easy to manage.</p>
      ...
      {
        id: "react-crud-premium-ch2",
        courseId: REACT_CRUD_COURSE_ID,
        chapterIndex: 1,
        title: "Why React",
        description: "Understanding why React is great for CRUD applications.",
        steps: [
          {
            id: "react-crud-premium-step2",
            courseId: REACT_CRUD_COURSE_ID,
            chapterId: "react-crud-premium-ch2",
            chapterTitle: "Why React",
            chapterIndex: 1,
            stepIndex: 0,
            stepType: "html",
...
// export default ManageList;`,
      ...
      {
        id: "react-crud-premium-ch3",
        courseId: REACT_CRUD_COURSE_ID,
        chapterIndex: 2,
        title: "Create Pattern",
        description: "Learn how to create new items in React.",
        steps: [
          {
            id: "react-crud-premium-step5",
            courseId: REACT_CRUD_COURSE_ID,
            chapterId: "react-crud-premium-ch3",
            chapterTitle: "Create Pattern",
            chapterIndex: 2,
            stepIndex: 0,
            stepType: "html",
            title: "Create pattern",
...
// export default ManageList;`,
      ...
      {
        id: "react-crud-premium-ch4",
        courseId: REACT_CRUD_COURSE_ID,
        chapterIndex: 3,
        title: "Read Pattern",
        description: "Learn how to read and display data in React.",
        steps: [
          {
            id: "react-crud-premium-step8",
            courseId: REACT_CRUD_COURSE_ID,
            chapterId: "react-crud-premium-ch4",
            chapterTitle: "Read Pattern",
            chapterIndex: 3,
            stepIndex: 0,
            stepType: "html",
            title: "Read pattern",
...
// export default ManageList;`,
      ...
      {
        id: "react-crud-premium-ch5",
        courseId: REACT_CRUD_COURSE_ID,
        chapterIndex: 4,
        title: "Update Pattern",
        description: "Learn how to update existing items in React.",
        steps: [
          {
            id: "react-crud-premium-step11",
            courseId: REACT_CRUD_COURSE_ID,
            chapterId: "react-crud-premium-ch5",
            chapterTitle: "Update Pattern",
            chapterIndex: 4,
            stepIndex: 0,
            stepType: "html",
            title: "Update pattern",
...
// export default ManageList;`,
      ...
      {
        id: "react-crud-premium-ch6",
        courseId: REACT_CRUD_COURSE_ID,
        chapterIndex: 5,
        title: "Delete Pattern",
        description: "Learn how to delete items in React.",
        steps: [
          {
            id: "react-crud-premium-step14",
            courseId: REACT_CRUD_COURSE_ID,
            chapterId: "react-crud-premium-ch6",
            chapterTitle: "Delete Pattern",
            chapterIndex: 5,
            stepIndex: 0,
            stepType: "html",
            title: "Delete pattern",
        ...
        steps: [
          {
            ...
            courseId: REACT_CRUD_COURSE_ID,
            chapterId: "react-crud-premium-ch7",
